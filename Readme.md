...
```bash 
pkg install git 
git clone https://github.com/candradwicahyo/country-guide.git
```

## preview dan demo 

![preview](https://github.com/candradwicahyo/country-guide/blob/master/image.jpg)

[tekan link ini](https://candradwicahyo.github.io/country-guide) untuk mencoba demo 